...
public class ARPrototypeModel implements IOverrideModel {
    ...
    public void render(
        ...
        RenderUtil.renderModel(SpecialModels.AR_PROTOTYPE_MAIN.getModel(), stack, matrixStack, buffer, light, overlay);
        ...
        if (entity.equals(Minecraft.getInstance().player)) {
            ...
            RenderUtil.renderModel(SpecialModels.AR_PROTOTYPE_HANDLE.getModel(), stack, matrixStack, buffer, light, overlay);
            //Always pop
            matrixStack.popPose();

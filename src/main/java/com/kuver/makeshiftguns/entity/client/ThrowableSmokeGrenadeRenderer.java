...
public class ThrowableSmokeGrenadeRenderer extends EntityRenderer<ThrowableSmokeGrenadeEntity> {
    ...
    @Nullable
    @Override
    public ResourceLocation getTextureLocation(ThrowableSmokeGrenadeEntity entity) {
        return null;
    }

    @Override
    public void render(ThrowableSmokeGrenadeEntity entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource renderTypeBuffer, int light) {
        poseStack.pushPose();
